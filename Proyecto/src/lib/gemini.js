...
export async function requestGeminiRecommendation({
  ...
  const composedPrompt = [
    ...
    "- Redacta respuestas en párrafos fluidos, sin viñetas ni enumeraciones. Habla en plural (\"la comunidad comenta\") cuando cites reseñas públicas.",
    "- Ofrece máximo 3 recomendaciones con viñetas o listado numerado.",
