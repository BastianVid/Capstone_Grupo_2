...
export function DocumentalesView() {
  ...
  return {
    ...
    async bind() {
      ...
      // Importar modelo y obtener datos
      const { ContentModel } = await import('../models/contentModel.js');
      let dataRaw = await ContentModel.listDocumentales();
      ...
      // Búsqueda global
      window.addEventListener("globalSearch", (e) => applyFilters(e.detail.query));
